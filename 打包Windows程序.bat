...
title Attendance Assistant Build
echo ==============================
echo Attendance Assistant Build
echo ==============================
echo.
echo Log file:
echo %LOG_FILE%
...
%PY_CMD% -m pip install --upgrade pip pyinstaller ttkbootstrap pandas openpyxl xlrd holidays chinese-calendar >> "%LOG_FILE%" 2>&1
if errorlevel 1 (
...
%PY_CMD% -m PyInstaller --noconfirm --clean attendance_gui.spec >> "%LOG_FILE%" 2>&1
if errorlevel 1 (
